...
export const explanatoryWarning = "AI responses may be inaccurate or misleading. AI generates answers based on text patterns, and mistakes can happen due to incomplete or biased training data, or not fully understanding questions.";
